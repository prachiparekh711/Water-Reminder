...
public class SleepPage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_page4);
        ...
        if (gender.equals("Male")) {
            figure.setImageDrawable(getResources().getDrawable(R.drawable.ic_boy_on_bed));
        } else {
            figure.setImageDrawable(getResources().getDrawable(R.drawable.ic_girl_on_bed));
        }

        r1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(SleepPage4.this, GenderPage1.class);
                startActivity(in);
            }
        });
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(SleepPage4.this, WeightPage2.class);
                startActivity(in);
            }
        });
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(SleepPage4.this, WakeUpPage3.class);
                startActivity(in);
            }
        });
        ...
        next2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(SleepPage4.this, AnimationActivity.class);
                startActivity(in);
            }
        });
        ...
        wheelView.setInitialPosition(22);
